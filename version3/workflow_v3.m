...
setupMotionCorrection(hSI, refStack, ...
    ...
    'gainXY',               1, ...
    'gainZ',                1, ...
    'dryRun',               false, ...   % <<< SET TO false ONCE TIMING LOOKS GOOD
    'diag',                 true, ...   % print per-phase timing at acqModeDone
    'xSign',                1, ...
    'ySign',                1, ...
    'zSign',                1, ...
    'minNCC_correction',     0.3, ...
    'minMoveInterval_s',    10, ... 
    'zPeakMargin',          0);
...
%global MCORR_STATE; MCORR_STATE.enabled = true;
